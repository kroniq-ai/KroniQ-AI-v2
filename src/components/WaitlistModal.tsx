...
import { WAITLIST_AUTO_OPEN_MODAL_KEY } from "@/lib/waitlist/storage";
...
export default function WaitlistModal() {
    ...
    const headerSubtitle = () => {
        if (step === 0) return "We're in early access. Join with your email — we'll reach out when your spot opens.";
                                    ...
                                    {step === 0 && (
                                        ...
                                        >
                                            <p className="text-[12px] text-white/40 leading-relaxed">
                                                Drop your email to claim your spot on the private beta waitlist.
                                            </p>
                                            <div>
                                    ...
                                    {step === 1 && (
                                        ...
                                        >
                                            ...
                                            <p className="text-[14px] text-white/35 font-light leading-relaxed max-w-[300px] mx-auto mb-1">
                                                {alreadyJoined
                                                    ? "You're already signed up. We'll email you when your spot opens."
                                                    : "We'll reach out when your spot opens. Watch your inbox for the invite."}
                                            </p>
                                            {profileSavedBanner ? (
