                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 items-center">
                    ...
                    >
                        ...
                        >
                            ...
                            <span className="text-[11px] font-bold uppercase tracking-[0.18em] text-white/50">Private beta · Limited spots</span>
                        </div>
                        ...
                        <p className="text-[16px] leading-relaxed" style={{ color: "rgba(255,255,255,0.42)" }}>
                            ...
                            Top 3 referrers get free Pro access at launch.
                        </p>
