        ...
        <>
            ...
            >
                <footer className="fixed bottom-0 left-0 flex h-screen w-full flex-col justify-between overflow-hidden bg-black text-white">
                    ...
                    <div className="absolute top-12 left-0 w-full overflow-hidden border-y border-white/[0.07] bg-black/80 py-3 z-10 -rotate-2 scale-110 shadow-2xl">
                        ...
                        <div ref={linksRef} className="flex flex-col items-center gap-4 w-full">
                            ...
                            <div className="flex flex-wrap items-center justify-center gap-3">
                                ...
                                <button
                                    ...
                                    className="rounded-full bg-white px-8 py-3.5 text-sm font-semibold text-black shadow-[0_16px_40px_-16px_rgba(0,0,0,0.5)] transition hover:bg-white/90"
                                >
                                    Get early access →
                                </button>
