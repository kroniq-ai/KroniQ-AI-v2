        ...
        <div className={cn("relative w-full overflow-hidden transition-colors duration-700", palette.surface, className)}>
            ...
            >
                ...
                <div className="flex justify-center">
                    <KinsoKicker label={introLabel} variant="dark" animated className="mb-0 max-w-md" />
                </div>
                    ...
                    {keys.map((key) => {
                        ...
                        return (
                            <button
                                ...
                                className={cn(
                                    "relative inline-flex items-center rounded-full px-5 py-2.5 text-[13px] font-semibold transition-all duration-300",
                                    isSel
                                        ? cn(glassDark.pill, glassDark.navLinkActive, "text-white/90")
                                        : cn(glassDark.pill, "text-white/45 hover:text-white/75"),
                                )}
                            >
                                ...
                                >
                                    ...
                                    <div className="flex min-w-0 flex-1 flex-col gap-4">
                                        <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:gap-4">
                                            ...
                                            {meta ? (
                                                <span className={cn(glassDark.pillCompact, "sm:ml-auto")}>
                                                    {meta}
                                                </span>
                                            ) : null}
                                        </div>
