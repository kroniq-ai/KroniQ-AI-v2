...
export const SITEMAP_LANDING_ROUTES: {
  ...
  { path: "/#platform", name: "Product", description: "Mission command, action queue, lead sourcing, and memory in one KroniQ workspace." },
  { path: "/#how-it-works", name: "How it works", description: "One company memory, parallel campaigns, and execution while you focus on building." },
  ...
  { path: "/signup", name: "Sign up", description: "Create your KroniQ account with a one-time email code." },
