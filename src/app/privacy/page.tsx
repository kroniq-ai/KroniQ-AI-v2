    ...
    return (
        <LegalDocShell title="Privacy policy" lastUpdated={lastDisplay}>
            ...
            <ul>
                ...
                <li>
                    <strong className="text-foreground">Campaign data</strong> — if you arrive via a tracked link or
                    promotion, we may store identifiers needed to understand how you found us.
                </li>
            </ul>
